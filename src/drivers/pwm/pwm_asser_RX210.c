...
{
    MTU0.TCR.BYTE=0x21; // CCLR[2,0]=001 : cleaned by TGR
    ...
    MTU0.TGRA=320; //définie la frequence du pwm, ici 50hz pour piloter un cerveau moteur
    MTU0.TGRB=160; //évite au moteur de se bloquer en 0°
